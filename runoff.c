...
{
    // TODO
    //Iterate over candidates votes
    //if candidate[i] votes > vote_number/2
    //printf(candidate)
    //return true
...
int find_min(void)
{
    ...
    for (int o = 1; o < candidate_count; o++)
    {
        ...
        {
            if (candidates[o].votes < candidates[o - 1].votes)
            {
                int min = candidates[o].votes;
            }
        }
    }
...
{
    // TODO
    //for candidate.eliminated = false candidates
    //if every candidate vote = min
    //return true;
